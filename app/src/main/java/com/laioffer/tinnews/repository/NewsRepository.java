...
public class NewsRepository {
    ...
    public LiveData<NewsResponse> getTopHeadlines(String country) {
        //returned is not response directly, but a livedata. We create this topic, viewModel will listen to this topic
    ...
    public void onCancel() {
        if (asyncTask != null) {
            ...
            //asyncTask.cancel:  when fragment is destroyed, some requests may still be ongoing,  we need to stop such tasks
        }
    }
